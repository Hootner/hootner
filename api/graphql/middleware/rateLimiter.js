...
class RateLimiter {
     ...
     */
    static async checkEndpointRateLimit(endpoint, identifier, maxRequests = 10, windowSeconds = 60) {
        return this.checkRateLimit(`endpoint:${endpoint}:${identifier}`, maxRequests, windowSeconds);
    }
