...
const root = {
  ...
  users: async () => {
    ...
    return [
      { id: '1', email: 'user@hootner.com', name: 'Demo User', subscription: 'premium', createdAt: new Date().toISOString() }
    ];
  },
  ...
  videos: async () => {
    ...
    return [
      { id: '1', title: 'Demo Video', url: '/videos/demo.mp4', status: 'ready', userId: '1', createdAt: new Date().toISOString() }
    ];
  },
