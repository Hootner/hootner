...
const scenarios = { 'chaos-monkey': `node tests/chaos/chaos-monkey.js --duration=${duration}`,
...
try { execSync(scenarios[scenario] || scenarios['chaos-monkey'], { stdio: 'inherit' }); } catch (error) { console.error('❌ Chaos test failed: ', error.message);
  process.exit(1);' }
