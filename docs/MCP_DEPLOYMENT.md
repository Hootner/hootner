...
1. **Build & Push Image**
   ...
   docker tag hootner-mcp:latest 123456789.dkr.ecr.us-east-1.amazonaws.com/hootner-mcp:latest
   docker push 123456789.dkr.ecr.us-east-1.amazonaws.com/hootner-mcp:latest
   ```
