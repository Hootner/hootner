  ...
  return (
    <div className={`relative ${className}`}>
      ...
      >
        ...
        {hoverTime !== null && (
          <>
            <div className="absolute top-0 h-full w-0.5 bg-white opacity-50" style={{ left: `${hoverProgress}%` }} />
            <div className="absolute -top-8 transform -translate-x-1/2 bg-black bg-opacity-90 text-white text-xs px-2 py-1 rounded" style={{ left: `${hoverProgress}%` }}>
